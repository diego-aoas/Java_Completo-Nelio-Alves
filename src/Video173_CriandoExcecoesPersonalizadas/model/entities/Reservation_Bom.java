...
public class Reservation_Bom {
    ...
    public Reservation_Bom(Integer roomNumber, Date checkIn, Date checkOut) {
        if (!checkOut.after(checkIn)) {
            throw new DomainException("Chek-out data must be after check-in date.");
        }
